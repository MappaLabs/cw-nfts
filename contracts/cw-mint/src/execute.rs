...
use cosmwasm_std::{Binary, Deps, DepsMut, Env, MessageInfo, Response, Uint128, WasmMsg, to_binary, CosmosMsg};

use cw2::set_contract_version;
use cw721::{CustomMsg, Cw721Execute, Cw721ReceiveMsg, Expiration};

use crate::error::ContractError;
use crate::msg::{ExecuteMsg, InstantiateMsg, MintMsg, Extension};
use crate::state::{Approval, Cw721Contract, TokenInfo, Config, CONFIG};

// version info for migration info
const CONTRACT_NAME: &str = "crates.io:cw-mint";
    ...
    pub fn execute(
        ...
        match msg {
            ...
            ExecuteMsg::Cw20ReceiveMsg { sender, amount } => {
                self.execute_receive(deps, info, sender, amount)
            }
        }
    }
}
